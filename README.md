...
| 12 | 11/21 | **Lec9** Modeling Structured Outputs and Conditional Random Fields (CRFs). [slides](https://github.com/inf16nyu/home/blob/master/slides/lecture9.pdf) <br /> Exponential families, maximum likelihood estimation, moment matching, maximum entropy, pseudo-likelihood. <br /><br />**No lab this week** |  |  |
